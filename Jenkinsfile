...
configMap.put("APP_RUN_COMMAND", "sh -c 'mkdir -p /root/.cache/ms-playwright && ln -sf /mnt/.devops_uv_cache/venv/browsers/* /root/.cache/ms-playwright/ && BROWSER_USE_API_KEY=\"bu_Knxmi4asdasdmapjAQxKBAvsNGpQyLE_TMrptArfXI\" PLAYWRIGHT_BROWSERS_PATH=/mnt/.devops_uv_cache/venv/browsers exec /mnt/.devops_uv_cache/venv/bin/gunicorn -c gunicorn.conf.py app:app'")  // 程序启动命令
