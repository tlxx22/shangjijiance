...
configMap.put("APP_RUN_COMMAND", "PLAYWRIGHT_BROWSERS_PATH=\$UV_PROJECT_ENVIRONMENT/browsers \$UV_PROJECT_ENVIRONMENT/bin/gunicorn -c gunicorn.conf.py app:app")  // 程序启动命令
