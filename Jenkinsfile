...
configMap.put("APP_RUN_COMMAND", "sh -c 'BROWSER_USE_API_KEY=\"bu_Knxmi4asdasdmapjAQxKBAvsNGpQyLE_TMrptArfXI\" PLAYWRIGHT_BROWSERS_PATH=\$UV_PROJECT_ENVIRONMENT/browsers exec \$UV_PROJECT_ENVIRONMENT/bin/gunicorn -c gunicorn.conf.py app:app'")  // 程序启动命令
